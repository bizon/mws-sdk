...
class Finances {
  constructor(client) {
    ...
    this.listFinancialEvents = new Throttler(30, {
      amount: 1,
      interval: 2 * 1000
    }).proxy(this[_listFinancialEvents].bind(this))

    this.listFinancialEventGroups = new Throttler(30, {
      amount: 1,
      interval: 2 * 1000
    }).proxy(this[_listFinancialEventGroups].bind(this))
  }
