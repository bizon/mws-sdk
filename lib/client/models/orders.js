...
class Orders {
  ...
  async [_getOrder]({amazonOrderId}) {
    ...
    const {getOrderResult} = parseGetOrderResponse('/orders:GetOrderResponse', parseXml(body))
  ...
  async [_getServiceStatus]() {
    ...
    return parseGetServiceStatusResponse('/orders:GetServiceStatusResponse', parseXml(body))
