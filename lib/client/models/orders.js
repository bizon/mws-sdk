...
class Orders {
  constructor(client) {
    ...
    this.getOrders = new Throttler(6, {
      amount: 1,
      interval: 60 * 1000
    }).proxy(this[_getOrders].bind(this))

    this.listOrders = new Throttler(6, {
      amount: 1,
      interval: 60 * 1000
    }).proxy(this[_listOrders].bind(this))

    this.listOrderItems = new Throttler(30, {
      amount: 1,
      interval: 2 * 1000
    }).proxy(this[_listOrderItems].bind(this))
  }
