  ...
  switch (notificationMetadata.notificationType) {
    ...
    case 'TestNotification':
      return {
        ...
        notificationPayload: parseTestNotification(
          `${key}/NotificationPayload/TestNotification`,
          node,
        ),
      }
    ...
    case 'AnyOfferChangedNotification':
      return {
        notificationMetadata,
        notificationPayload: parseAnyOfferChanged(
          `${key}/NotificationPayload/AnyOfferChangedNotification`,
          node,
        ),
      }
    ...
    case 'FeedProcessingFinishedNotification':
      return {
        notificationMetadata,
        notificationPayload: parseFeedProcessingFinished(
          `${key}/NotificationPayload/FeedProcessingFinishedNotification`,
          node,
        ),
      }
    ...
    case 'ReportProcessingFinishedNotification':
      return {
        notificationMetadata,
        notificationPayload: parseReportProcessingFinished(
          `${key}/NotificationPayload/ReportProcessingFinishedNotification`,
          node,
        ),
      }
