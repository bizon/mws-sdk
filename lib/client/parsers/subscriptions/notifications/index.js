...
const parseFeePromotion = require('./fee-promotion')
...
module.exports = (key, node) => {
  ...
  switch (notificationMetadata.notificationType) {
    ...
    case 'FeePromotion':
    case 'FeePromotionNotification':
      return {
        notificationMetadata,
        notificationPayload: parseFeePromotion(`${key}/NotificationPayload/FeePromotionNotification`, node)
      }
