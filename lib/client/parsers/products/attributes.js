...
module.exports = (key, node) => ({
  ...
  itemDimensions: parseDimensions(`${key}/ns2:ItemAttributes/ns2:ItemDimensions`, node),
  label: parseStr(`${key}/ns2:ItemAttributes/ns2:Label`, node),
  manufacturer: parseStr(`${key}/ns2:ItemAttributes/ns2:Manufacturer`, node),
  materialType: parseStr(`${key}/ns2:ItemAttributes/ns2:MaterialType`, node),
  ...
  packageDimensions: parseDimensions(`${key}/ns2:ItemAttributes/ns2:PackageDimensions`, node),
