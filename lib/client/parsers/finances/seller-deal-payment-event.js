...
module.exports = (key, node) => ({
  ...
  dealId: parseStr([`${key}/finances:dealId`, `${key}/finances:DealId`], node),
  ...
  eventType: parseStr([`${key}/finances:eventType`, `${key}/finances:EventType`], node),

  feeType: parseStr([`${key}/finances:feeType`, `${key}/finances:FeeType`], node),
