...
module.exports = (key, node) => ({
  ...
  rentalChargeList: select(`${key}/finances:RentalChargeList/finances:ChargeComponent`, node).map(n => parseChargeComponent('.', n)),
  rentalFeeList: select(`${key}/finances:RentalFeeList/finances:FeeComponent`, node).map(n => parseFeeComponent('.', n)),
  ...
  rentalTaxWithheldList: select(`${key}/finances:RentalTaxWithheldList/finances:TaxWithheldComponent`, node).map(n => parseTaxWithheldComponent('.', n)),
})
